...
import EmContact from './EmContact';
...
export default function Emergency({ navigation }) {
    ...
    function pushComplaint(name, phoneNo, address, complaint) {
        ...
        const postListRef = ref(database, '/Parking/complaints/');
            ...
            <View style={{ marginHorizontal: 10 }}>
                <View
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        <TouchableOpacity style={{ marginRight: 10, paddingTop: 2 }}
                        ...
                        <View
                            ...
                            <View style={{}}>
                                <View style={{ flexDirection: 'row' }}>
                                    <Text
                                        style={[
                                            crName == true ? { color: 'red' } : { color: 'black' },
                                            {
                                                backgroundColor: 'white',
                                                padding: 5,
                                                top: 12,
                            ...
                            <View>
                                <View style={{ flexDirection: 'row' }}>
                                    <Text
                                        style={[
                                            crPhoneNo == true ? { color: 'red' } : { color: 'black' },
                                            {
                                                backgroundColor: 'white',
                                                padding: 5,
                                                top: 12,
                            ...
                            <View>
                                <View style={{ flexDirection: 'row' }}>
                                    <Text
                                        style={[
                                            crAddress == true ? { color: 'red' } : { color: 'black' },
                                            {
                                                backgroundColor: 'white',
                                                padding: 5,
                                                top: 12,
